...
<!--     <link href="dist/AdminLTE/plugins/iCheck/flat/blue.css" rel="stylesheet" type="text/css" /> -->
    ...
    <link rel="stylesheet" href="dist/pulgins/layui/css/layui.css">
<!--     自定义CSS -->
    <link href="dist/comstomer/css/def.css" rel="stylesheet" type="text/css" />
    ...
    <![endif]-->   
    <script src="dist/js/pureJS.js" type="text/javascript"></script> 