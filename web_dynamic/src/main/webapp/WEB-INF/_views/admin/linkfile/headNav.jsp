              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ${acUser.userName }                   <small><fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" /> </small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
            ...
            <c:if test="${acUser.type == 1 }">
			 ...
			 <li class="treeview">
              <a href="javascript:void(0);">
                <i class="fa fa-dashboard"></i> <span>考勤系统</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu ">
              
              <c:if test="${acUser.type == 3 || acUser.type == 1}">
              <li class=""><a href="admin_access/attendance/classList.do"><i class="fa fa-circle-o"></i>开始考勤</a></li>
              <li class=""><a href="admin_access/attendance/classRecordList.do"><i class="fa fa-circle-o"></i>考勤记录(教师)</a></li>
              </c:if>
             
             <c:if test="${acUser.type == 2 }">
             <li class=""><a href="admin_access/attendance/StudentRecord.do"><i class="fa fa-circle-o"></i>考勤记录(学生)</a></li>
			 ...
			 <li class="treeview">
              ...
              <ul class="treeview-menu ">
               ...
               <c:if test="${acUser.type == 3 || acUser.type == 1}">
               	<li class=""><a href="admin_access/ex/teacherView0.do"><i class="fa fa-circle-o"></i>请假审批(教师)</a></li>
               </c:if>
