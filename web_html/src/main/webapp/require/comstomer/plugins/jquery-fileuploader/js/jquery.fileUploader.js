...
(function($) {
	...
	$.fn.fileUploader = function(config){
		...
		* Individual Upload
		*/
		$('.upload', pxUploadForm).on('click',null, function(){
		...
		//Button Clear Event
		$(config.buttonClear, pxButton).on('click',null, function(){
		...
		$('.delete', pxUploadForm).on('click',null, function(){
		...
		*/
		$('.cancel', pxUploadForm).on('click',null, function() {
			if (jqxhr) {
				jqxhr.abort();
			}
		...
		*	Cancel all uploads
		*/
		$('#px-cancel', pxButton).on('click',null, function(){
			stopUpload = true;
			if (jqxhr) {
				jqxhr.abort();
			}
		...
		/* Icons hover */
		$(".px-widget .actions li").on("mouseover mouseout",null, function(event) {
